...
export function getStoredBooleanOrDefault(
  key: string,
  defaultVal: boolean
): boolean {
...
export function getStoredNumberOrDefault(
  key: string,
  defaultVal: number
): number {
  const storedVal = localStorage.getItem(key);
...
export function createBooleanLocalStorageBehaviorSubject(
  key: string,
  defaultVal: boolean
...
export function createNumberLocalStorageBehaviorSubject(
  key: string,
  defaultVal: number
